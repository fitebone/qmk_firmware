 ...
 */
 ...
 [_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_LBRC,  KC_RBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RSFT, \
                      KC_LALT, KC_LGUI, LT(_LOWER, KC_SPC),KC_SPC,  KC_ENT, LT(_RAISE, KC_ESC),  KC_BSPC, KC_RGUI \
),
/* QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
 ...
 */
  [_ADJUST] = LAYOUT( \
  SAVE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QWERTY, COLEMAK, \
